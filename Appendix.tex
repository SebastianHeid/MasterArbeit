...
Fig. \ref{fig:AppxBlockAnalysisRemovalDouble} and Fig. \ref{fig:AppxBlockAnalysisRemovalSingle} present qualitative example of a generated images when one complete double- or single-stream block is removed. 

Fig. \ref{fig:AppxBlockAnalysisCompressionDouble} and Fig. \ref{fig:AppxBlockAnalysisCompressionSingle} present qualitative example of a generated images when one complete double- or single-stream block is compressed via truncated \gls{SVD}. 
...
Example images for various compressed models (68\%, 57\% and 43\%) are presented here obtained with the random and importance-aware block selection for Flux.1-dev as described in Sec. \ref{sec:FluxBlockImportanceAnalysis}.
...
\section{Linear Progressive SVD Compression - Preliminary Experiments}
