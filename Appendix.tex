...
\section{Compression Strategy}
   	...
   	\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{images/Experimente/SVD_VS_Removal/PixartArchitectureCompressedModules.pdf}
...
\end{figure}
	...
	\caption[Qualitative Comparison of Compression Strategies]{Qualitative examples for \gls{SVD}-based compression versus block removal used to compress PixArt-$\Sigma$ to 90\% of the original size.}
	\label{fig:Example_Images_SVD_vs_Removal_Appx}
\end{figure}

   	\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{images/Experimente/SVD_VS_Removal/ImageExamples_model80.pdf}
	\caption[Qualitative Comparison of Compression Strategies]{Qualitative examples for \gls{SVD}-based compression versus block removal used to compress PixArt-$\Sigma$ to 80\% of the original size.}
	\label{fig:Example_Images_SVD_vs_Removal_Appx}
\end{figure}
	...
	\caption[Qualitative Comparison of Compression Strategies]{Qualitative examples for \gls{SVD}-based compression versus block removal used to compress PixArt-$\Sigma$ to 70\% of the original size.}
	\label{fig:Example_Images_SVD_vs_Removal_Appx}
\end{figure}
	...
	\caption[Qualitative Comparison of Compression Strategies]{Qualitative examples for \gls{SVD}-based compression versus block removal used to compress PixArt-$\Sigma$ to 60\% of the original size.}
	\label{fig:Example_Images_SVD_vs_Removal_Appx}
\end{figure}
...
\section{Importance-Aware Rank-Adaptive Progressive Model Pruning}
...
\end{table}
	...
	\label{fig:AppxCompressionSchedules}
\end{figure}
...
\begin{table}[t]
	...
	{%
		\begin{tabular}{cccccc}
			...
			\\
			\midrule
			\multicolumn{6}{c}{FLUX.dev\cite{Flux}}\\
			\midrule
			100 &      % start P
			90 &    % end P
			20000 &    % steps
	...
	\smallskip
	\caption{\textbf{Training details.} For every training of from a start parameter budget to an end parameter budget $P_{start}\longrightarrow P_{end}$ we provide the number of compressed blocks $K$, with the maximum compression $c_m$, the compression slope $\alpha$, and the number of training steps. For readability, we provide $\alpha$ scaled by 1000.}
