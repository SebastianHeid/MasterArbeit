...
\begin{table}[H]
	...
	\begin{tabular}{ccccc}
		...
		&&\textbf{Modified Blocks}&\textbf{Ratio}& \textbf{Ratio} $x$\\
		\midrule
...
\begin{figure}[H]
	...
	\caption[Qualitative Examples: Failure Cases in SVDtrunc - Appendix]{Qualitative comparison of example images generated at varying compression ratios using SVDtrunc, illustrating failure cases observed with increasing compression levels.}
	\label{fig:SVDtrunc_Failure_Cases_Appx}
\end{figure}


\section{Evaluation SVDtrunc on Step-Distilled DiT}
\label{appx:FluxSchnell}
This section provides additional qualitative example for Flux.1-schnell compressed via \gls{SVD}trunc (Fig. \ref{fig:FluxSchnellAppx}). As with Flux.1-dev, both domain shift (Fig. \ref{fig:FluxSchnellAppxDomainShift}) and memorization loss (Fig. \ref{fig:FluxSchnellAppxMemoLoss}) occur over the course of compression.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{images/Experimente/Flux/FluxSchnell/FluxSchnellAppx.pdf}
	\caption[Qualitative Examples: SVDtrunc on Flux.1-Schnell - Appendix]{Qualitative comparison of example images generated by Flux.1-schnell compressed via SVDtrunc to varying sizes utilizing four inference steps.}
...
\begin{figure}[H]
	...
	\caption[Qualitative Examples: Domain Shift in SVDtrunc on Flux.1-Schnell - Appendix]{Qualitative comparison of example images generated by Flux.1-schnell compressed via SVDtrunc, illustrating the gradual domain-shift observed with increasing compression levels.}
...
\begin{figure}[H]
	...
	\caption[Qualitative Examples: Domain Shift in SVDtrunc on Flux.1-Schnell - Appendix]{Qualitative comparison of example images generated by Flux.1-schnell compressed via SVDtrunc, illustrating the gradual memorization loss observed with increasing compression levels.}
	\label{fig:FluxSchnellAppxMemoLoss}
\end{figure}

\section{GRASP for \gls{DiT}s}
