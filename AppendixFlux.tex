...
\begin{table}[H]
	\centering
	\caption[SVDtrunc FLUX.1 {[schnell]}: Compression Details]{Overview of the experimental settings for the FLUX.1 [schnell] compression, detailing how the removed parameters are distributed across varying numbers of blocks. For readability, the linear decay rate $x$ is scaled by 1000.}
