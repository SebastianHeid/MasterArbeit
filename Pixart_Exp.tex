...
\subsection{Black-Box Optimization with Optuna}
- 11 blocks
- fixed compression
- target: cmmd value
- prior was necessary
...
\subsection{Direct vs Iterative Layer Removal}
\subsection{Global Layer Removal vs. Local Dimensional Compressio}
\subsection{Component-Specific Scaling}
...
\section{Main Contribution: Linear Iterative Compression}