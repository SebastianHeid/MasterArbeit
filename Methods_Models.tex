...
\begin{figure}[H]
	...
	\caption{Overview Flux.1-dev architecture.}
\label{FluxOverview}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Single-stream block (left) and double-stream block (right) of Flux.1-dev. Graphics are adapted from \cite{FastFlux}.}
...
\begin{table}[h]
	\centering
	\caption{Number of parameters for the individual components of double-stream block from Flux.1-dev.}
