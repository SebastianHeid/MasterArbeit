...
\subsection{Feature Distribution for Loss Computation}

\begin{figure}[t]
	\centering
	\includegraphics[width=\textwidth]{images/Methoden/LossRemoval.pdf}
	\caption{ }
	\label{fig:LossRemoval}
\end{figure}


\begin{figure}[t]
	\centering
	\includegraphics[width=\textwidth]{images/Methoden/LossCompression.pdf}
	\caption{ }
	\label{fig:LossCompression}
\end{figure}
